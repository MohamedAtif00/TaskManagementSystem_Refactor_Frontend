...
import { TaskSheetParams, TaskSheetRepository } from '../../domain/repository/task-sheet.repository';
...
export class TaskSheetImplementationRepository implements TaskSheetRepository {
  ...
  getSheet(params: TaskSheetParams): Observable<TaskSheetEntity> {
    const source = environment.useMock ? this.local.getSheet(params) : this.remote.getSheet(params);
